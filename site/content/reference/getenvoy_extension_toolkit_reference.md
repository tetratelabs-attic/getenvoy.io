...
💡 The following _property names_ can be used in context of `{{ .GetEnvoy.DefaultValue "<property>" }}`
...
Refers to `.getenvoy/extension/extension.yaml` file generated by [`getenvoy extension init`].

#### Toolchain

Refers to `.getenvoy/extension/toolchains/default.yaml` file generated on first use of [`getenvoy extension build`].

#### Example setup

Refers to _Envoy_ configuration generated by [`getenvoy extension examples add`].

`Example setup` represents `Envoy` configuration that demonstrates the extension in action on real traffic.

#### Example descriptor

Refers to `example.yaml` file of the `Example setup`.

#### WebAssembly module

Refers to `*.wasm` file generated by [`getenvoy extension build`].
